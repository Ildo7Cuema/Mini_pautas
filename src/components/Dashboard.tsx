    ...
    return (
        <div className="space-y-6">
            ...
            <div>
                ...
                <p className="text-slate-600">Aqui está um resumo das suas turmas e alunos</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                >
                    <CardBody className="p-6 text-center">
                        ...
                        <h4 className="font-semibold text-slate-900 mb-1">Nova Turma</h4>
                        <p className="text-sm text-slate-600">Criar uma nova turma</p>
                    </CardBody>
                </Card>
                ...
                >
                    <CardBody className="p-6 text-center">
                        ...
                        <h4 className="font-semibold text-slate-900 mb-1">Lançar Notas</h4>
                        <p className="text-sm text-slate-600">Registrar notas dos alunos</p>
                    </CardBody>
                </Card>
                ...
                >
                    <CardBody className="p-6 text-center">
                        ...
                        <h4 className="font-semibold text-slate-900 mb-1">Gerar Relatório</h4>
                        <p className="text-sm text-slate-600">Criar mini-pauta</p>
                    </CardBody>
                </Card>
            </div>
            {/* Create Class Modal */}
            {showCreateModal && (                    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50 animate-fade-in">
