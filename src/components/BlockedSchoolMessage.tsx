                                    ...
                                    <div className="mt-4 p-3 bg-white rounded-lg border border-blue-200">
                                        ...
                                        <div className="grid grid-cols-2 gap-2 text-xs">
                                            <div>
                                                ...
                                                <span className="ml-1 font-medium text-neutral-800">{dadosBancarios.banco}</span>
                                            </div>
                                            <div>
                                                <span className="text-neutral-500">Titular:</span>
                                                <span className="ml-1 font-medium text-neutral-800">{dadosBancarios.titular}</span>
                                            </div>
                                            <div className="col-span-2">
                                                <span className="text-neutral-500">Conta:</span>
                                                <span className="ml-1 font-mono font-medium text-neutral-800">{dadosBancarios.conta}</span>
                                            </div>
                                            <div className="col-span-2">
                                                <span className="text-neutral-500">IBAN:</span>
                                                <span className="ml-1 font-mono font-medium text-neutral-800">{dadosBancarios.iban}</span>
                                            </div>
                                        </div>
                                    </div>
                                )}
                        ...
                        <div className="bg-slate-50 rounded-lg p-4 border border-slate-200">
                            ...
                            <ul className="space-y-2 text-sm text-slate-600">
                                ...
                                <li className="flex items-start gap-2">
                                    ...
                                    <div className="flex-1">
                                        <p className="mb-1 font-medium">Suporte EduGest Angola - WhatsApp</p>
                                        {superAdminContact ? (
                                            <div className="flex flex-wrap items-center gap-2">
                                                <strong className="text-green-600">{superAdminContact.numero}</strong>
                                            </div>
                                        ) : (
